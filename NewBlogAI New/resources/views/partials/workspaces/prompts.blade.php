                                ...
                                <div id="prompt-pane-editor" class="prompt-tab-view space-y-4">
                                    ...
                                    <div class="space-y-1.5">
                                        ...
                                        <div class="flex flex-wrap gap-1" id="prompt-variables-container">
                                            ...
                                            <span onclick="insertPromptVar('headline')" class="prompt-var-chip px-2 py-0.5 rounded bg-white/5 border border-border text-[9px] font-mono text-muted cursor-pointer hover:border-accent hover:text-text transition">&#123;&#123;headline&#125;&#125;</span>
                                            <span onclick="insertPromptVar('summary')" class="prompt-var-chip px-2 py-0.5 rounded bg-white/5 border border-border text-[9px] font-mono text-muted cursor-pointer hover:border-accent hover:text-text transition">&#123;&#123;summary&#125;&#125;</span>
                                            ...
                                            <span onclick="insertPromptVar('sources')" class="prompt-var-chip px-2 py-0.5 rounded bg-white/5 border border-border text-[9px] font-mono text-muted cursor-pointer hover:border-accent hover:text-text transition">&#123;&#123;sources&#125;&#125;</span>
                                            <span onclick="insertPromptVar('research_context')" class="prompt-var-chip px-2 py-0.5 rounded bg-white/5 border border-border text-[9px] font-mono text-muted cursor-pointer hover:border-accent hover:text-text transition">&#123;&#123;research_context&#125;&#125;</span>
                                        </div>
                                    </div>
