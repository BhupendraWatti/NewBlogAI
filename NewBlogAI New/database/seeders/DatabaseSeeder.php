...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $prompt1 = Promt::create([
            ...
            'promt' => 'Synthesize the latest news on the topic {{topic}} into an engaging weekly newsletter format. Use markdown. Website: {{website}}.',
            'status' => 'active',
        ]);

        $prompt2 = Promt::create([
            'name' => 'Tech Blog Writer',
            'promt' => 'Write a deeply analytical blog post about {{topic}}. Language: {{language}}. Keep the tone professional. Website: {{website}}.',
            'status' => 'active',
        ]);
